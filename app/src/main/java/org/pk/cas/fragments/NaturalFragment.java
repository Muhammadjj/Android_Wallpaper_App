...
public class NaturalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.natural_recycler_View);
        progressBar = view.findViewById(R.id.natural_progress_Bar);

        reference = FirebaseDatabase.getInstance().getReference().child("Natural");
